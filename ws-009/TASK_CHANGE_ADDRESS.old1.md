let's be more explicit with the phases.

1. read all current delivery addresses and save it to file
2. read it again and make sure it's stable
3. test the mutation
4. check and make sure it changed
5. back out using another mutation
6. check and make sure state has reverted to #1
7. spawn a subagent to review the current session transcript and see if anything went wrong
